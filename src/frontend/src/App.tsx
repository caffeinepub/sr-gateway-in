...
export default function App() {
  ...
  if (!profile) {
    // If user already has MPIN set, they are a registered user -- profile is still loading
    // Don't show SetupProfile screen to avoid prompting for name again
    ...
    <div className="min-h-screen bg-background flex justify-center">
      <div className="w-full max-w-[430px] relative flex flex-col min-h-screen">
        <main className="flex-1 pb-20 overflow-y-auto">
          ...
          {screen === "admin" && (
            <AdminPanel onBack={() => setScreen("profile")} />
          )}
          {screen === "myapi" && (
